...
var board_to_fen_exports = {};
__export(board_to_fen_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(board_to_fen_exports);
  ...
  try {
    ...
    if (isFlipped) {
      const reversedRows = rows.map((row) => {
        ...
        return reversed.replace(/1+/g, (m2) => m2.length);
      }).reverse();
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=board-to-fen.js.map
